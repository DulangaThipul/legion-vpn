...
export default function ThreeScene() {
  ...
  useEffect(() => {
    ...
    try {
      // 🚀 Container එකේ ප්‍රමාණයන් හෝ Window size හරියටම ලබා ගැනීම
      ...
      // Lights (Matching original ambient & directional lights)
      ...
      starGroup.rotation.z = Math.PI / 4; // Original tilt angle
      starGroup.add(starPoints);
      scene.add(starGroup);

      // 2. Wireframe Icosahedron Shape (Matching original args and opacity 0.5)
