...
export default function DashboardTabs({ user: initialUser }: { user: any }) {
  ...
  const handleConfirmOrder = async () => {
    ...
    try {
      ...
      if (res?.success) {
        setUser(res.user);
        alert("Order Submitted! Your receipt was uploaded and sent to Admin for review.");
      } else {
        alert("Uploaded! Admin will review your payment.");
      }
  ...
  return (
    <div style={{ minHeight: "100vh", background: "transparent", color: "#FFFFFF", paddingBottom: "100px", position: "relative" }}>
      ...
      {/* 🚀 SCREEN CENTER BIG CUSTOM POPUP MODAL */}
